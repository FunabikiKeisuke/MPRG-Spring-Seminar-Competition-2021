...
def WideResNet16():
    return WideResNet(depth=16, width_factor=8, dropout=0., in_channels=1, labels=47)


def WideResNet22():
    return WideResNet(depth=22, width_factor=10, dropout=0., in_channels=1, labels=47)


def WideResNet28():
    return WideResNet(depth=28, width_factor=10, dropout=0., in_channels=1, labels=47)


def WideResNet34():
    return WideResNet(depth=34, width_factor=10, dropout=0., in_channels=1, labels=47)


def WideResNet40():
    return WideResNet(depth=40, width_factor=12, dropout=0., in_channels=1, labels=47)


def WideResNet101():
    return WideResNet(depth=101, width_factor=2, dropout=0., in_channels=1, labels=47)
